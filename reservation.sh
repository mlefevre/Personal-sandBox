...
### Personal parameters : customise those to your needs.
DESIRED_DATE=${1:-$(date -u +'%Y-%m-%d' -d "+ 28 days")}	# set the desired date to 'today + 28 days'
USER_MAIL="mlefevre@paradigm.brussels"			# your email adress
USER_FIRSTNAME="Marc"
...
## Those parameters must be guessed from booking run in your broweser console.
SEAT="307"	# =param meetingRoomId, must be guessed from your usage
LAYOUT="313"	# roomLayoutId ... seems useless, but may be related to seat localisation ??
TOKEN="dee5d8c1-ae09-4c0a-a8ad-2adb393ddfaa"	# personal, must be edited !

CREATION_DATE=$(date -u +'%Y-%m-%dT%T.%3NZ')	# = today
...
# update connection tokens from your personal token
